...
class Day19Test {
    ...
    fun sameStateInputTest1() {
        val input = File("input/aoc2021/input19sameStates.txt").useLines { parseInput(it.toList()) }
    ...
    fun exampleInputTest1() {
        val input = File("input/aoc2021/input19example.txt").useLines { parseInput(it.toList()) }
        assertEquals(5, input.size)
    ...
    @Test
    fun inputTestPart1() {
        val input = File("input/aoc2021/input19.txt").useLines { parseInput(it.toList()) }
        merge(input)
