...
class Day24Test {
    ...
    fun calcTestPart1() {
        ...
        assertEquals(0, File("input/aoc2021/input24example.txt").useLines { calculate(it,"4").z.value })
        assertEquals(1, File("input/aoc2021/input24example.txt").useLines { calculate(it,"5").z.value })
    }
    ...
    @Test
    fun inputTestPart1() {
        assertEquals(0, File("input/aoc2021/input24.txt").useLines { calculate(it,"99995969919326").z.value })
    }
    @Test
    fun inputTestPart2() {
        assertEquals(0, File("input/aoc2021/input24.txt").useLines { calculate(it,"48111514719111").z.value })
    }
