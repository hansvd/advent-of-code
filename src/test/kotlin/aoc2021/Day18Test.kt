...
[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]"""
    ...
    @Test
    fun inputTestPart1() {
        assertEquals(3699, File("input/aoc2021/input18.txt").useLines { parseInputLines(it).magnitude()     })
    }
    ...
    @Test
    fun inputTestPart2() {
        assertEquals(4735, File("input/aoc2021/input18.txt").useLines { part2(it) })
    }
