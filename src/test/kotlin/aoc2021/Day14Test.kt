...
//    }
    ...
    @Test
    fun day14aTest() {
        assertEquals(2797, File("input/aoc2021/input14.txt").useLines { day14(it) }.result())
    }
    ...
    @Test
    fun day14bTest() {
        assertEquals(2926813379532, File("input/aoc2021/input14.txt").useLines { day14(it,40) }.result())
    }
