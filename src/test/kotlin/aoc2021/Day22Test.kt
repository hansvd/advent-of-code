...
class Day22Test {
    ...
    fun inputTestPart1Example() {
        assertEquals(590784, File("input/aoc2021/input22example1.txt").useLines { invoke(it, -50..50) })
    }

    @Test
    fun inputTestPart1() {
        assertEquals(607657, File("input/aoc2021/input22.txt").useLines { invoke(it, -50..50) })
    }

    @Test
    fun inputTestPart2aExample() {
        assertEquals(474140, File("input/aoc2021/input22example2.txt").useLines { invoke(it, -50..50) })
    }

    @Test
    fun inputTestPart2Example() {
        assertEquals(2758514936282235, File("input/aoc2021/input22example2.txt").useLines { invoke(it) })
    }

    @Test
    fun inputTestPart2() {
        assertEquals(1187742789778677, File("input/aoc2021/input22.txt").useLines { invoke(it) })
    }
