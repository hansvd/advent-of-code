...
//        assertEquals(-50..50, (-150..150).overlap(-50..50))
        ...
        assertEquals(27+19-8,part1("on x=10..12,y=10..12,z=10..12\non x=11..13,y=11..13,z=11..13\noff x=9..11,y=9..11,z=9..11".lineSequence(),-50..50))
       assertEquals(590784, part1(testInput.lineSequence(), -50..50))
    ...
    @Test
    fun inputTestPart1() {
        assertEquals(607657, File("input/input22.txt").useLines { part1(it, -50..50) })
    }
    ...
    @Test
    fun inputTestPart2() {
        assertEquals(0, File("input/input22.txt").useLines { part2(it) })
    }
