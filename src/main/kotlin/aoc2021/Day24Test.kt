...
import aoc2021.Day24.calculate
...
class Day24Test {
    ...
    fun calcTestPart1() {
        ...
        assertEquals(0, File("src/main/kotlin/aoc2021/input24example.txt").useLines { calculate(it,"4").z.value })
        assertEquals(1, File("src/main/kotlin/aoc2021/input24example.txt").useLines { calculate(it,"5").z.value })
    }
    ...
    @Test
    fun inputTestPart1() {
        assertEquals(0, File("src/main/kotlin/aoc2021/input24.txt").useLines { calculate(it,"99995969919326").z.value })
    }
    @Test
    fun inputTestPart2() {
        assertEquals(0, File("src/main/kotlin/aoc2021/input24.txt").useLines { calculate(it,"48111514719111").z.value })
    }
