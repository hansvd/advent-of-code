...
9899965678"""
    ...
    @Test
    fun advent9aTest() {
        assertEquals(458, File("src/main/kotlin/aoc2021/input9.txt").useLines { advent9a(it) })
    }
    ...
    @Test
    fun advent9bTest() {
        assertEquals(1391940, File("src/main/kotlin/aoc2021/input9.txt").useLines { advent9b(it) })
    }
