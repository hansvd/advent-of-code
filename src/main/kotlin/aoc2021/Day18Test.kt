...
import aoc2021.Day18.SnailFishValue
import aoc2021.Day18.parseInput
import aoc2021.Day18.parseInputLines
import aoc2021.Day18.parseValue
import aoc2021.Day18.part2
import aoc2021.Day18.toValue
...
[[[[5,2],5],[8,[3,7]]],[[5,[7,5]],[4,4]]]"""
    ...
    @Test
    fun inputTestPart1() {
        assertEquals(3699, File("src/main/kotlin/aoc2021/input18.txt").useLines { parseInputLines(it).magnitude()     })
    }
    ...
    @Test
    fun inputTestPart2() {
        assertEquals(4735, File("src/main/kotlin/aoc2021/input18.txt").useLines { part2(it) })
    }
