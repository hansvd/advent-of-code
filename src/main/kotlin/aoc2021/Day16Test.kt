...
import aoc2021.Day16.hexToBinString
...
class Day16Test {
    ...
    @Test
    fun day16aTest() {
        assertEquals(923, part1(File("src/main/kotlin/aoc2021/input16.txt").readText()))
    }
    ...
    @Test
    fun day16bTest() {
        assertEquals(258888628940, part2(File("src/main/kotlin/aoc2021/input16.txt").readText()))
    }
