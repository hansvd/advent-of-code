...
import aoc2021.Day19.Coordinates
import aoc2021.Day19.match
import aoc2021.Day19.maxDistance
import aoc2021.Day19.merge
import aoc2021.Day19.parseInput
...
class Day19Test {
    ...
    fun sameStateInputTest1() {
        val input = File("src/main/kotlin/aoc2021/input19sameStates.txt").useLines { parseInput(it.toList()) }
    ...
    fun exampleInputTest1() {
        val input = File("src/main/kotlin/aoc2021/input19example.txt").useLines { parseInput(it.toList()) }
        assertEquals(5, input.size)
    ...
    @Test
    fun inputTestPart1() {
        val input = File("src/main/kotlin/aoc2021/input19.txt").useLines { parseInput(it.toList()) }
        merge(input)
