...
start-RW"""
    ...
    @Test
    fun day12aTest() {
        assertEquals(3497, File("src/main/kotlin/aoc2021/input12.txt").useLines { part1(it) })
    }
    ...
    @Test
    fun day12bTest() {
        assertEquals(93686, File("src/main/kotlin/aoc2021/input12.txt").useLines { part2(it) })
    }
