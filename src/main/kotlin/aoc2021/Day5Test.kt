...
import aoc2021.Advent5.advent5a
import aoc2021.Advent5.advent5b
import aoc2021.Advent5.parseLine
...
5,5 -> 8,2"""
    ...
    @Test
    fun advent5aTest() {
        assertEquals(7644, File("src/main/kotlin/aoc2021/input5.txt").useLines { advent5a(it) })
    }
    ...
    @Test
    fun advent5bTest() {
        assertEquals(18627, File("src/main/kotlin/aoc2021/input5.txt").useLines { advent5b(it) })
    }
